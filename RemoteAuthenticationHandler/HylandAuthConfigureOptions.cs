...
public sealed class HylandAuthConfigureOptions : IConfigureNamedOptions<OpenIdConnectOptions>
{
    ...
    /// <summary>
    /// Initializes a new <see cref="HylandAuthConfigureOptions"/> given the configuration
    /// provided by the <paramref name="configurationProvider"/>.
    /// </summary>
    /// <param name="configurationProvider">An <see cref="IAuthenticationConfigurationProvider"/> instance.</param>
    public HylandAuthConfigureOptions(IAuthenticationConfigurationProvider configurationProvider)
    {
        _authenticationConfigurationProvider = configurationProvider;
    }

    public void Configure(OpenIdConnectOptions hylandAuthOptions)
        => Configure(OpenIdConnectDefaults.DisplayName, hylandAuthOptions);
    /// <inheritdoc />    
