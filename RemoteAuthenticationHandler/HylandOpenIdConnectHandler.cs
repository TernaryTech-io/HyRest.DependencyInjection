...
//    /// <summary>
//    /// Initializes a new instance of <see cref="HylandOpenIdConnectHandler"/>.
//    /// </summary>
//    /// <param name="options">A monitor to observe changes to <see cref="HylandAuthOptions"/>.</param>
//    /// <param name="logger">The <see cref="ILoggerFactory"/>.</param>
//    /// <param name="htmlEncoder">The <see cref="System.Text.Encodings.Web.HtmlEncoder"/>.</param>
//    /// <param name="encoder">The <see cref="UrlEncoder"/>.</param>
//    public HylandOpenIdConnectHandler(IOptionsMonitor<HylandAuthOptions> options, ILoggerFactory logger, HtmlEncoder htmlEncoder, UrlEncoder encoder)
...
//                }
//                return HandleRequestResult.Fail("The request contiained unexpected parameters");
//            }
//        }
//        // assumption: if the ContentType is "application/x-www-form-urlencoded" it should be safe to read as it is small.
//        else if (HttpMethods.IsPost(Request.Method)
...
//                return HandleRequestResult.SkipHandler();
//            }
//            return HandleRequestResult.Fail("The request had no message");
//        }
...
//                        return HandleRequestResult.SkipHandler();
//                    }
//                    return HandleRequestResult.Fail("Message State Is Null Or Empty");
//                }
...
//                return HandleRequestResult.Fail("Message State Is Invalid");
//            }
...
//            throw new SecurityTokenException(string.Format(CultureInfo.InvariantCulture, "Validated Security Token Not Jwt", validatedToken?.GetType()));
//        }
...
//            throw new SecurityTokenException(string.Format(CultureInfo.InvariantCulture, "Unable To Validate Token From Handler", idToken));
//        }

//        if (validatedToken is not JsonWebToken)
//        {
//            Logger.InvalidSecurityTokenTypeFromHandler(validatedToken?.GetType());
//            throw new SecurityTokenException(string.Format(CultureInfo.InvariantCulture, "Validated Security Token Not Json Web Token", validatedToken?.GetType()));
//        }
